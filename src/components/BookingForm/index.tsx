  ...
  return (
    <Container {...props} id="menu">
      ...
      <Form onSubmit={formik.handleSubmit} noValidate>
        <label htmlFor="res-date">Wybierz datę</label>
        ...
        <label htmlFor="res-time">Wybierz godzinę</label>
        ...
        <label htmlFor="occasion">Okazja</label>
        <select data-testid="occasion" id="occasion" {...formik.getFieldProps("occasion")}>
          <option value="birthday" className="opt">Urodziny</option>
          <option value="engagement" className="opt">Zaręczyny</option>
          <option value="anniversary" className="opt">Rocznica</option>
        </select>
        <FormMessageError data-testid="occasion-error">
          {formik.touched.occasion && formik.errors.occasion}
        </FormMessageError>
        <input data-testid="submit-btn" type="submit" value="Złóż rezerwację" />
      </Form>
    </Container>
  );
};
